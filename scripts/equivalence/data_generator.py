...
class EqualDataGenerator(ABC):
    ...
    def __init__(self, dataset_dir, config, evals_allowed_in_train, complete_pattern_per_line=False,
        ...
        self.attributes = ['a' + str(i) for i in range(self.conf.ATTRIBUTES_AMOUNT)] if entity_list else set()
    ...
    @abstractmethod
    def create_complete_facts(self, relation, attributes, available_entities):
        pass
