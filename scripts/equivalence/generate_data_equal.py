...
import numpy
import config
from scripts.equivalence.equal_data_generator import EqualDataGenerator
...
if __name__ == '__main__':
    ...
    shutil.copy(config.implication_config, os.path.join(DATA_DIR, '../implication/datagen_config.py'))
